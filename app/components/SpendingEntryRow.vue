  ...
  <tr :class="item.checked ? 'opacity-50' : ''" class="border-b border-secondary last:border-0">
    ...
    <td class="py-2 pr-1 align-middle w-[100px]">
      <input
        v-model="item.date"
        type="date"
        class="w-full min-h-[36px] rounded-md border border-transparent bg-white px-1 text-xs focus:border-secondary focus:bg-white outline-none"
      />
    </td>
    ...
    <td class="py-2 pr-1 align-middle w-[110px]">
      <input
        ...
        class="w-full min-h-[36px] rounded-md border border-transparent bg-white px-2 text-xs focus:border-secondary focus:bg-white outline-none"
      />
    </td>
